    ...
    <div className="max-w-7xl mx-auto px-6 py-12 md:py-20 animate-fade-in">
      ...
      {isLoading ? (
        ...
        <div className="text-center py-20 border border-dashed border-gray-300">
          <p className="text-gray-500">No products found in the database. Please check your Supabase connection.</p>
        </div>
      ) : (
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse min-w-[600px]">
            ...
            <tbody className="text-sm">
              {isLoading ? (
                <tr>
                  <td colSpan="5" className="p-8 text-center text-gray-500">Loading database records...</td>
                </tr>
              ) : products.length === 0 ? (
                <tr>
